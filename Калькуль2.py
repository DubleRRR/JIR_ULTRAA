...
block3 = ctk.CTkFrame(root, width=425, height=178, border_width=1, border_color='#CBD5E1', fg_color='#E2E8F0')
block3.grid_propagate(False)
block3.place(x=410, y=15)

#Окно скорости звука
block4 = ctk.CTkFrame(block3, width=190, height=110, fg_color='#F0F4F8') #border_width=1, border_color='#CBD5E1'
block4.grid_propagate(False)
block4.place(x=15, y=50)

#Окно расстояния
block5 = ctk.CTkFrame(block3, width=190, height=110, fg_color='#F0F4F8')
...
label2 = ctk.CTkLabel(block, text='Температура воздуха', text_color='#475569', font=("Century Gothic", 15, 'bold'))
